...
interface EventContextType {
  ...
  userEvents: Event[];
  createEvent: (
    eventData: Omit<Event, "id" | "currentAttendees" | "startDate" | "endDate">
  ) => void;
...
//     description:
//       "Join the biggest technology conference of the year featuring AI, blockchain, and web development.",
//     organizer: {
//       id: "org1",
...
//     description:
//       "Watch innovative startups pitch their ideas to top investors and win funding.",
//     organizer: {
//       id: "org4",
...
//     description:
//       "Hands-on workshop exploring modern art techniques and digital design.",
//     organizer: {
//       id: "org5",
...
//     registeredCount: 35,
//     image:
//       "https://images.pexels.com/photos/1153213/pexels-photo-1153213.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
...
//     description:
//       "Explore cutting-edge contemporary art from emerging and established artists.",
//     organizer: {
//       id: "org6",
...
//     description:
//       "Intensive training camp for marathon runners with professional coaches.",
//     organizer: {
//       id: "org7",
...
//     description:
//       "Annual community basketball tournament with prizes for winning teams.",
//     organizer: {
//       id: "org8",
...
//     title: "Jazz Festival",
//     description:
//       "Three-day jazz festival featuring renowned artists and emerging talents.",
//     organizer: {
//       id: "org9",
...
//     description:
//       "Learn about electronic music production, DJing, and the music industry.",
//     organizer: {
//       id: "org10",
...
//     title: "Science Fair",
//     description:
//       "Annual science fair showcasing innovative projects from students and researchers.",
//     organizer: {
//       id: "org11",
...
//     description:
//       "Intensive weekend coding bootcamp for beginners to learn web development.",
//     organizer: {
//       id: "org12",
...
export const EventProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const getEventAnalytics = (eventId: string): EventAnalytics | null => {
    ...
    return {
      ...
      totalRevenue: Number(event.currentAttendees) * Number(event.price),
      attendanceRate: 0.85,
      demographicData: {
