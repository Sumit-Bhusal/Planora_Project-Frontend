...
}> = ({ user, activeTickets, registerForEvent }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 via-blue-50 to-purple-50 dark:from-secondary-900/20 dark:via-blue-900/20 dark:to-purple-900/20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Button
            icon={Search}
            className="h-16 flex-col space-y-1 bg-gradient-to-r from-secondary-600 to-blue-600 hover:from-secondary-700 hover:to-blue-700 text-white font-bold shadow-lg"
          ...
          <Button
            variant="outline"
            icon={TrendingUp}
            className="h-16 flex-col space-y-1 border-purple-200 dark:border-purple-700 text-purple-700 dark:text-purple-300 hover:bg-purple-50 dark:hover:bg-purple-900/30"
          ...
          {mlLoading ? (
            ...
            <Card className="p-12 text-center bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-purple-200 dark:border-purple-800">
              ...
              <p className="text-gray-500 dark:text-dark-text-tertiary mb-6">
                Browse events to help us understand your preferences
              </p>
              <Button
                icon={Search}
