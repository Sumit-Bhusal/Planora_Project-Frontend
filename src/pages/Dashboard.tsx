...
const Dashboard: React.FC = () => {
  ...
  // const organizerEvents = isOrganizer
  //   ? events.filter((event) => event.organizer.id === user.id)
  //   : [];
  const recommendedEvents = !isOrganizer
    ? getRecommendedEvents(user.interests || [])
    : [];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-3">
              <Button
                ...
                className={
                  isOrganizer
                    ? "border-primary-200 dark:border-primary-700 text-primary-700 dark:text-primary-300 hover:bg-primary-50 dark:hover:bg-primary-900/30"
                    : ""
                }
              >
                Notifications
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => (
            <Card
              key={index}
              className={`p-6 hover:scale-105 transition-all duration-300 border-0 shadow-lg ${
                isOrganizer
            ...
            {isOrganizer ? (
              ...
              <div className="space-y-8">
                ...
                <Card
                  className={`p-6 ${
                    isOrganizer
                      ? "bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-primary-200 dark:border-primary-700"
                      : ""
                  }`}
                >
                  ...
                  {organizerEvents.length > 0 ? (
                    ...
                    >
                      ...
                      <p className="text-gray-500 dark:text-dark-text-tertiary mb-6">
                        Start building your audience with our AI-powered event
                        creation tools
                      </p>
                      <Button
                        icon={Plus}
                ...
                <Card className="p-6">
                  ...
                  {recommendedEvents.length > 0 ? (
                    ...
                    <Card className="p-12 text-center bg-gradient-to-br from-secondary-50 to-blue-50 dark:from-secondary-900/20 dark:to-blue-900/20 border-secondary-200 dark:border-secondary-800">
                      ...
                      <p className="text-gray-500 dark:text-dark-text-tertiary mb-6">
                        Set your interests to get personalized event
                        recommendations
                      </p>
                      <Button
                        icon={Search}
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium text-gray-900 dark:text-white">
                          New registration for Tech Meetup
                        </p>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium text-gray-900 dark:text-white">
                          Event "Music Festival" published
                        </p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          1 hour ago
                        </p>
