...
const UserTickets: React.FC = () => {
  ...
  const filteredTickets = userTickets.filter((ticket) => {
    const matchesSearch =
      ...
      ticket.bookingDetails.fullName
        .toLowerCase()
  ...
  const stats = [
    ...
    {
      label: "Total Spent",
      value: `NPR ${userTickets
        .reduce((sum, ticket) => sum + ticket.originalPrice, 0)
        .toLocaleString()}`,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {stats.map((stat, index) => (
            <Card key={index} className="p-6 text-center">
              <div
                className={`inline-flex items-center justify-center w-12 h-12 rounded-full ${stat.bgColor} ${stat.color} mb-4`}
              >
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <select
                ...
                onChange={(e) =>
                  setStatusFilter(
                    e.target.value as "all" | "active" | "cancelled" | "used"
                  )
                }
        ...
        {filteredTickets.length > 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="font-medium text-gray-900 dark:text-dark-text-primary">
                          NPR {ticket.originalPrice.toLocaleString()}
                        </span>
                      </div>
                      <div className="flex items-center space-x-2">
                    ...
                    <div className="mt-4 p-3 bg-gray-50 dark:bg-dark-bg-tertiary rounded-lg">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                        <div>
                          ...
                          <span className="font-mono font-medium text-gray-900 dark:text-dark-text-primary ml-2">
                            {ticket.ticketId}
                          </span>
                        </div>
                        <div>
                          ...
                          <span className="font-medium text-gray-900 dark:text-dark-text-primary ml-2">
                            {ticket.bookingDetails.age} years
                          </span>
                        </div>
                        <div>
                          <span className="text-gray-600 dark:text-dark-text-secondary">
          ...
          <Card className="p-12 text-center">
            ...
            {userTickets.length === 0 && <Button>Browse Events</Button>}
          </Card>
        )}
      </div>
